...
<section class="flex">
  ...
  <div class="flex flex-col flex-1">
    ...
    <div class="flex flex-col md:flex-row py-4 items-center justify-center gap-6 h-full px-32">
      ...
      <form method="POST" action="{{ route('comments.store') }}" class="flex-1">
        @csrf
        ...
        <div class="mb-4 form-control">
          ...
          <input type="text" name="post_id" id="post_id" class="input input-bordered" placeholder="Enter post id" required/>
