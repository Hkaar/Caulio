  ...
  <div class="flex flex-col flex-1">
    ...
    <div class="flex flex-col md:flex-row py-4 items-center justify-center gap-6 h-full px-32">
      <div id="preview" class="flex-1 flex items-center justify-center">
        <img src="{{ Storage::url($forum->img) }}" class="size-36 md:size-72 rounded-full object-cover"></img>
      </div>

      <form method="POST" action="{{ route('forums.update', $forum->id) }}" enctype="multipart/form-data" class="flex-1">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4 form-control">
          ...
          <input class="input input-bordered flex items-center" type="text" name="title" id="title" class="grow" placeholder="{{ $forum->title }}" required/>
        ...
        <div class="mb-6 form-control">
          ...
          <textarea class="textarea textarea-bordered" id="desc" name="desc" placeholder="{{ $forum->desc }}"></textarea>
